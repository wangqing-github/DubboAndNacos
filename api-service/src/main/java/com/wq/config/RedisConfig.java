...
public class RedisConfig extends CachingConfigurerSupport {
    @Autowired
    private GenericRedisPoolConfig genericRedisPoolConfig;
    @Autowired
    ...
    public LettuceConnectionFactory redisConnectionFactory() {
        ...
        redisStandaloneConfiguration.setHostName(genericRedisPoolConfig.getHost());
        redisStandaloneConfiguration.setPort(genericRedisPoolConfig.getPort());
        // redisStandaloneConfiguration.setPassword("password"); // 取消注释以设置密码

        // 配置连接池
        GenericObjectPoolConfig<Object> poolConfig = new GenericObjectPoolConfig<>();
        poolConfig.setMaxTotal(lettuceConfig.getMaxActive());       // 连接池中的最大连接数
        poolConfig.setMaxIdle(lettuceConfig.getMaxIdle());         // 连接池中的最大空闲连接数
        poolConfig.setMinIdle(lettuceConfig.getMinIdle());         // 连接池中的最小空闲连接数
        poolConfig.setMaxWait(Duration.ofMillis(lettuceConfig.getMaxWait())); // 连接池获取连接的最大等待时间
